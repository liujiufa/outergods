...
import '../assets/style/componentStyle/ReportModal.scss'
...
import outLinkIcon from '../assets/image/outLinkIcon.png'
...
export default function ScreenModal(props: any) {
  ...
  return (
    <Modal visible={props.isShow} destroyOnClose={true} centered closable={false} footer={null} width={624} className="ReportModal">
      <div className="confirmModalTop">
        <div className="title">举报此集合</div>
      ...
      <div className="selectBox">
        <Dropdown overlay={typeMenu} trigger={['click']} onVisibleChange={() => handleDropDown(setExpand7, expand7)}>
      ...
      <div className="ModalFooter">
        <div className="reportBtn flexCenter" onClick={submit}>举报</div>
      </div>
    </Modal>
  )
}
