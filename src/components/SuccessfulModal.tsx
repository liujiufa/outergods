...
import '../assets/style/componentStyle/SuccessfulModal.scss'
...
export default function ScreenModal(props: any) {
  ...
  return (
    <Modal visible={props.isShow} destroyOnClose={true} centered closable={false} footer={null} width={624} className="SuccessfulModal">
      ...
      <div className="bigBox">
        <div className="topBox Box">
          ...
          <div className="right">
            <div className="title">项目名（Collection)</div>
            Rat3
          </div>
        </div>
        ...
        <div className="bottomBox Box">
          <div className="left">
            <div className="title">NFT合约</div>
            Ox578...242d <img src={outLinkIcon} alt="" />
          </div>
          <div className="right">
      ...
      <div className="ModalFooter">
        <div className="enterBtn flexCenter" onClick={submit}>完成</div>
      </div>
    </Modal>
  )
}
